    ...
    columns: [
      ...
      */

      {
        ...
        cardOrderIds: ['card-id-111-placeholder-card'], // card đặc biệt này sẽ luôn nằm ở vị trí đầu tiên của column khi column đó rỗng
        cards: [
          {
            _id: 'card-id-111-placeholder-card',
            boardId: 'board-id-01',
